package com.example.prak9new.ui.pages
...
import com.example.prak9new.ui.viewmodel.FormErrorState
import com.example.prak9new.ui.viewmodel.FormState
import com.example.prak9new.ui.viewmodel.InsertUiState
import com.example.prak9new.ui.viewmodel.InsertViewModel
import com.example.prak9new.ui.viewmodel.MahasiswaEvent
import com.example.prak9new.ui.viewmodel.PenyediaViewModel
    ...
    LaunchedEffect(uiState) {
        when (uiState) {
            is FormState.Success -> { println(
                ...
                coroutineScope.launch { snackbarHostState.showSnackbar(uiState.message)
                    //Tampilkan snackbar
                }
                delay(700) // Navigasi langsung
                onNavigate()
                viewModel.reserSnackBarMessage() // Reset snackbar state
            }

            is FormState.Error -> { coroutineScope.launch {
...
@Composable
fun FormMahasiswa(
    mahasiswaEvent: MahasiswaEvent = MahasiswaEvent(), onValueChange: (MahasiswaEvent) -> Unit, errorState: FormErrorState = FormErrorState(), modifier: Modifier = Modifier
) {
